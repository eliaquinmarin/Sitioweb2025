  ...
  function shareOnSocialMedia(event) {
    ...
    switch (network) {
      case 'facebook':
        ...
        break;
      case 'twitter':
        shareUrl = `https://twitter.com/intent/tweet?text=Estoy escuchando esta radio online, te la recomiendo. ${radioName}! ${radioUrl} &hashtags=radio,musica`; // Adicione hashtags relevantes
        break;
      case 'whatsapp':
        shareUrl = `https://api.whatsapp.com/send?text=Estoy escuchando esta radio online, te la recomiendo ${radioName}! Vamos echa un viztaso: ${radioUrl}`;
        break;
      default:
        shareUrl = radioUrl; 
    }
